...
<title>My Review Articlesr</title>
</head>
<body>
<!--------------------------------------------------Header----------------------------------------------------------->
...
<h2>Articles being reviewed by you  </h2>
<table>
...
<tr>
    ...
    <th>Title</th>
    <th>Contributor</th>
    <th>Sent for Correction</th>
    <th>Action</th>
   
  </tr>
<c:forEach items="${myReviewArticles}" var="myReviewArticles">


 <c:if test="${myReviewArticles.isPublished() != true}">  

  <tr>
  
    <td>${myReviewArticles.getCategory().getName()}</td>
    <td>${myReviewArticles.getTitle()}</td>
    <td>${myReviewArticles.getContributor().getUsername()}</td>
    <td>${myReviewArticles.isReEdit()}</td>
    <td><a href="/edit/${myReviewArticles.getId()}">Edit</a></td>
